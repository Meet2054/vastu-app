  ...
  return (
    <div className="flex flex-col items-center gap-2 p-4 bg-card rounded-lg border shadow-sm">
      ...
      >
        ...
        {/* Cardinal Points */}
        <span className="absolute top-1 text-xs font-bold text-muted-foreground">
          N
        </span>
        <span className="absolute right-2 text-xs font-bold text-muted-foreground">
          E
        </span>
        <span className="absolute bottom-1 text-xs font-bold text-muted-foreground">
          S
        </span>
        <span className="absolute left-2 text-xs font-bold text-muted-foreground">
          W
        </span>
